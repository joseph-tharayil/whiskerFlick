...
def getDistance(csd1,csd2):
    ...
    sinks_mat, _, _, _, _ = compute_dist_matrix_exp([sinks1], [sinks2], mode = 'exp_to_reco',time_distance_scale_factor=.5)
    sources_mat, _, _, _, _ = compute_dist_matrix_exp([sources1], [sources2], mode = 'exp_to_reco',time_distance_scale_factor=.5)
...
if __name__=='__main__':
    ...
    np.save('distances_within_scaled_half.npy',distanceMat)
